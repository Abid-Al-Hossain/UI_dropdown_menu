# UI Foundry Dropdown Menu Studio

Standalone visual Dropdown Menu generator built with Next.js, React, and TypeScript.

Standalone Dropdown Menu component studio for building native, preview-honest, React-exportable UI patterns that match the UI Foundry product line.
...
- designers building Dropdown Menu UI quickly
- developers who need editable React starting points
- marketplace buyers who want a self-contained Dropdown Menu generator
...
The editor is focused on controls that are native to Dropdown Menu and useful in real product work:
- trigger, items, groups, separators, checked/radio items, disabled items, and submenu intent
- menu surface, item density, icon, shortcut, hover, focus, active, radius, border, and shadow
- account, actions, command, filter, and navigation menu archetypes
- menu semantics and keyboard expectations
- React export for dropdown menu shell

The goal is maximum useful depth without adding unrelated controls that would make the component stop reading as Dropdown Menu.
...
This repo is intended to publish as Abid-Al-Hossain/UI_dropdown_menu.
