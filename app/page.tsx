...
export default function Page() {
  const [state, setState] = useState<DropdownMenuState>(DEFAULT_DROPDOWNMENU_STATE);
  ...
  return <AppShell contentOverflow="hidden"><PlaygroundLayout title="Dropdown Menu Studio" controls={controls} preview={output} /></AppShell>;
}
