...
export default function Page() {
  ...
  return <AppShell contentOverflow="hidden"><PlaygroundLayout title="Dropdown Menu Studio" headerActions={headerActions} controls={controls} preview={output} /></AppShell>;
}
